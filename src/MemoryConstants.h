...
// number of bits in the offset, i.e. the number of bits used to address a word
// within a page/frame Also the number of bits used to address an entry within a
// page table
#ifndef OFFSET_WIDTH
...
#define CEIL(VARIABLE)                                                         \
  ((VARIABLE == (int)VARIABLE) ? (int)VARIABLE : (int)VARIABLE + 1)
#define TABLES_DEPTH                                                           \
...
static_assert(PHYSICAL_ADDRESS_WIDTH > OFFSET_WIDTH,
              "PHYSICAL_ADDRESS_WIDTH must be greater than OFFSET_WIDTH");
static_assert(VIRTUAL_ADDRESS_WIDTH > OFFSET_WIDTH,
              "VIRTUAL_ADDRESS_WIDTH must be greater than OFFSET_WIDTH");
